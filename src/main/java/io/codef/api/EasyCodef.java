...
public class EasyCodef {
	...
	public String requestProduct(String productUrl, EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		...
		if(!validationFlag) {
			EasyCodefResponse response = new EasyCodefResponse(io.codef.api.EasyCodefMessageConstant.EMPTY_CLIENT_INFO);
		...
		if(!validationFlag) {
			EasyCodefResponse response = new EasyCodefResponse(io.codef.api.EasyCodefMessageConstant.EMPTY_PUBLIC_KEY);
			return mapper.writeValueAsString(response);
		}
		...
		if(!validationFlag) {
			EasyCodefResponse response = new EasyCodefResponse(io.codef.api.EasyCodefMessageConstant.INVALID_2WAY_KEYWORD);
			return mapper.writeValueAsString(response);
		}
	 ...
	 * @throws InterruptedException
	 */
	public String requestCertification(String productUrl, io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		boolean validationFlag = true;
	...
	private boolean checkClientInfo(int serviceType) {
		if(serviceType == 0) {
			...
			if(io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_ID == null || "".equals(io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_ID.trim())) {
				return false;
			}
			if(io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_SECRET == null || "".equals(io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_SECRET.trim())) {
				return false;
			}
		}
		return true;
	 ...
	 * @throws InterruptedException
	 */
	public String createAccount(io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.CREATE_ACCOUNT, serviceType, parameterMap);
	}
	 ...
	 * @throws InterruptedException
	 */
	public String addAccount(io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.ADD_ACCOUNT, serviceType, parameterMap);
	}
	 ...
	 * @throws InterruptedException
	 */
	public String updateAccount(io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.UPDATE_ACCOUNT, serviceType, parameterMap);
	}
	 ...
	 * @throws InterruptedException
	 */
	public String deleteAccount(io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.DELETE_ACCOUNT, serviceType, parameterMap);
	}
	 ...
	 * @throws InterruptedException
	 */
	public String getAccountList(io.codef.api.EasyCodefServiceType serviceType, HashMap<String, Object> parameterMap) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.GET_ACCOUNT_LIST, serviceType, parameterMap);
	}
	 ...
	 * @throws InterruptedException
	 */
	public String getConnectedIdList(io.codef.api.EasyCodefServiceType serviceType) throws UnsupportedEncodingException, JsonProcessingException, InterruptedException {
		return requestProduct(io.codef.api.EasyCodefConstant.GET_CID_LIST, serviceType, null);
	}
	 ...
	 */
	public String requestToken(io.codef.api.EasyCodefServiceType serviceType) throws JsonParseException, JsonMappingException, IOException {
		...
		if(serviceType.getServiceType() == 0) {
			...
			clientId = io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_ID;
			clientSecret = io.codef.api.EasyCodefConstant.SANDBOX_CLIENT_SECRET;
		}
		
		String accessToken = io.codef.api.EasyCodefTokenMap.getToken(clientId); // 보유 중인 토큰이 있는 경우 반환
		if(accessToken != null) {
			HashMap<String, Object> tokenMap = io.codef.api.EasyCodefUtil.getTokenMap(accessToken);
		...
		if(tokenMap != null) {
			...
			io.codef.api.EasyCodefTokenMap.setToken(clientId, accessToken);	// 발급 토큰 저장
			return accessToken;
		} else {
			return null;
		}
